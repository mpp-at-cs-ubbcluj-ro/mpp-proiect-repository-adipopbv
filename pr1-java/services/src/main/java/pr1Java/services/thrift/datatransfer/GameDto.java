...
public class GameDto implements org.apache.thrift.TBase<GameDto, GameDto._Fields>, java.io.Serializable, Cloneable, Comparable<GameDto> {
  ...
  public @org.apache.thrift.annotation.Nullable String homeTeam; // required
  public @org.apache.thrift.annotation.Nullable String awayTeam; // required
  ...
  public GameDto setName(@org.apache.thrift.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public GameDto setHomeTeam(@org.apache.thrift.annotation.Nullable String homeTeam) {
    this.homeTeam = homeTeam;
    return this;
  }
  ...
  public GameDto setAwayTeam(@org.apache.thrift.annotation.Nullable String awayTeam) {
    this.awayTeam = awayTeam;
    return this;
  }
  ...
  public int compareTo(GameDto other) {
    ...
    lastComparison = Boolean.compare(isSetGameId(), other.isSetGameId());
    if (lastComparison != 0) {
    ...
    lastComparison = Boolean.compare(isSetHomeTeam(), other.isSetHomeTeam());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetHomeTeam()) {
    ...
    lastComparison = Boolean.compare(isSetAwayTeam(), other.isSetAwayTeam());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAwayTeam()) {
    ...
    lastComparison = Boolean.compare(isSetSeatCost(), other.isSetSeatCost());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSeatCost()) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("pr1Java.networking.thrift.dataTransfer.GameDto(");
    boolean first = true;
