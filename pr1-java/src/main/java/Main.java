...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        TicketRepository ticketRepository = new TicketDbRepository(properties, gameRepository);
        userRepository.add(new User(1, "adipopbv", "logged-out"));
        gameRepository.add(new Game(1, "Semifinals", "Rockets", "Celtics", 300));
        ticketRepository.add(new Ticket(1, gameRepository.getOne(1), 150));
